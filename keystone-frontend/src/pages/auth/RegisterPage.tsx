        ...
        <Card sx={{ width: '100%', maxWidth: 460 }}>
          <CardContent sx={{ p: 4 }}>
            <Stack spacing={2} alignItems="flex-start">
              <Typography variant="h4" fontWeight={800}>Account created</Typography>
              <Typography variant="body2" color="text.secondary">
                Your account has been created. Sign in with your new credentials to continue.
              </Typography>
        ...
        <CardContent sx={{ p: 4 }}>
          <Stack spacing={2}>
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">Set up access to Keystone.</Typography>
            </Box>
